...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, fr.insy2s.domain.Address.class.getName());
            createCache(cm, fr.insy2s.domain.Client.class.getName());
            createCache(cm, fr.insy2s.domain.Client.class.getName() + ".carts");
            createCache(cm, fr.insy2s.domain.CommandLine.class.getName());
            createCache(cm, fr.insy2s.domain.Product.class.getName());
            createCache(cm, fr.insy2s.domain.ProductType.class.getName());
