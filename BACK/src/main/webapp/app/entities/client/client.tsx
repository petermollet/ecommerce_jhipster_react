  ...
  return (
    <div>
      <h2 id="client-heading">
        <Translate contentKey="ecommerceApp.client.home.title">Clients</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="ecommerceApp.client.home.createLabel">Create new Client</Translate>
        </Link>
      </h2>
        ...
        {clientList && clientList.length > 0 ? (
            ...
            <tbody>
              {clientList.map((client, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{client.addressId ? <Link to={`address/${client.addressId}`}>{client.addressId}</Link> : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ecommerceApp.client.home.notFound">No Clients found</Translate>
            </div>
          )
        )}
      </div>
