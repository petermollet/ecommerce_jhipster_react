          ...
          {productList && productList.length > 0 ? (
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th>
                    <Translate contentKey="ecommerceApp.product.type">Type</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {productList.map((product, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{product.typeId ? <Link to={`product-type/${product.typeId}`}>{product.typeId}</Link> : ''}</td>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="ecommerceApp.product.home.notFound">No Products found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
