  ...
  return (
    <div>
      <h2 id="address-heading">
        <Translate contentKey="ecommerceApp.address.home.title">Addresses</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="ecommerceApp.address.home.createLabel">Create new Address</Translate>
        </Link>
      </h2>
        ...
        {addressList && addressList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ecommerceApp.address.home.notFound">No Addresses found</Translate>
            </div>
          )
        )}
      </div>
