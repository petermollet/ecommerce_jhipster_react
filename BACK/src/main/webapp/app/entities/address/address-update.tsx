  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ecommerceApp.address.home.createOrEditLabel">
            <Translate contentKey="ecommerceApp.address.home.createOrEditLabel">Create or edit a Address</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : addressEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="roadLabel" for="address-road">
