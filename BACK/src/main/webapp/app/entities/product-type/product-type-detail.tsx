...
export const ProductTypeDetail = (props: IProductTypeDetailProps) => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2>
          <Translate contentKey="ecommerceApp.productType.detail.title">ProductType</Translate> [<b>{productTypeEntity.id}</b>]
        </h2>
