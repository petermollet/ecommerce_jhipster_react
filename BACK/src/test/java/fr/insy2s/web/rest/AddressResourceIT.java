...
public class AddressResourceIT {
    ...
    public void createAddress() throws Exception {
        ...
        assertThat(testAddress.getRoad()).isEqualTo(DEFAULT_ROAD);
    ...
    @Test
    @Transactional
    public void checkRoadIsRequired() throws Exception {
        int databaseSizeBeforeTest = addressRepository.findAll().size();
        // set the field null
    ...
    public void updateAddress() throws Exception {
        ...
        assertThat(testAddress.getRoad()).isEqualTo(UPDATED_ROAD);
